...
const BodyDefault = ({ getActiveUser, getOpenUser }) => {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: 'url("/assets/themes/images/hero-banner/home-bg.jpg")' }}
      >
      ...
      <section className="porfolio-sec py-5" style={{ backgroundColor: '#FAFAFB' }}>
        <div className="container">
          <div className="row d-flex">
            ...
            <div className="col-lg-7 col-xl-8 maincontent ps-lg-5">
