...
const HeaderTheme2 = ({ themeHeader, getActiveUser, getOpenUser, logout }) => {
  
  return (
    <>
      <header className={`${themeHeader} header-3 shadow`}>
        <div className="top-nav">
          <div className="container position-sticky">
            <ul className="d-flex m-0 p-0">
              ...
              <li>
                <Link to={getOpenUser?.email ? getOpenUser?.email : ''}>
                  <span>
        ...
        <nav className="mainNav navbar navbar-expand-lg text-uppercase" id="mainNav">
                    ...
                    <ul className="navbar-nav ms-auto">
                      <div className="d-flex justify-content-center justify-content-lg-end">
                        <li className="dropdown">
                          <button type="button" className="btn nav-link py-0 pe-0 dropdown-toggle border-0 active-user dropdown-toggle"
